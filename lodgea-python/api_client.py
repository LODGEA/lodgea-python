...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.v1_availability_get_post  # this is an instance of the class Endpoint
        api_instance.v1_availability_get_post()  # this invokes api_instance.v1_availability_get_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.v1_availability_get_post.callable or self.callable in this class

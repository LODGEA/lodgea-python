...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.availability_search_post  # this is an instance of the class Endpoint
        api_instance.availability_search_post()  # this invokes api_instance.availability_search_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.availability_search_post.callable or self.callable in this class

...
class InlineResponse2003PropertyPropertyInfoAcceptedPaymentList(ModelNormal):
    ...
    def _from_openapi_data(cls, code, type, *args, **kwargs):  # noqa: E501
        """InlineResponse2003PropertyPropertyInfoAcceptedPaymentList - a model defined in OpenAPI

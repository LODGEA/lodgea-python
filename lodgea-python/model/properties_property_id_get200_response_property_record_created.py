...
class PropertiesPropertyIdGet200ResponsePropertyRecordCreated(ModelNormal):
    ...
    def _from_openapi_data(cls, user, tenant, time, *args, **kwargs):  # noqa: E501
        """PropertiesPropertyIdGet200ResponsePropertyRecordCreated - a model defined in OpenAPI

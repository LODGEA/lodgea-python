...
class V1PropertyGetPost200ResponsePropertyPropertyInfoLocation(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """V1PropertyGetPost200ResponsePropertyPropertyInfoLocation - a model defined in OpenAPI

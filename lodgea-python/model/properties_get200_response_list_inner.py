...
class PropertiesGet200ResponseListInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, published, name, property_id, image, address, last_updated, *args, **kwargs):  # noqa: E501
        """PropertiesGet200ResponseListInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, published, name, property_id, image, address, last_updated, *args, **kwargs):  # noqa: E501
        """PropertiesGet200ResponseListInner - a model defined in OpenAPI

...
class PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerFeePolicyListInner(ModelNormal):
    ...
    def _from_openapi_data(cls, type_code, charge_type, charge_frequency_code, currency_code, condition_list, *args, **kwargs):  # noqa: E501
        """PropertiesPropertyIdGet200ResponsePropertyPolicyListInnerFeePolicyListInner - a model defined in OpenAPI

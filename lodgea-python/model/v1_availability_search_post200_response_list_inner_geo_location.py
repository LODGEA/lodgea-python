...
class V1AvailabilitySearchPost200ResponseListInnerGeoLocation(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """V1AvailabilitySearchPost200ResponseListInnerGeoLocation - a model defined in OpenAPI

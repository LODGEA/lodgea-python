...
class AvailablePropertiesInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, currency_code, lowest_price, type, *args, **kwargs):  # noqa: E501
        """AvailablePropertiesInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, currency_code, lowest_price, type, *args, **kwargs):  # noqa: E501
        """AvailablePropertiesInner - a model defined in OpenAPI

...
class LocationSearch(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, search_text, *args, **kwargs):  # noqa: E501
        """LocationSearch - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, search_text, *args, **kwargs):  # noqa: E501
        """LocationSearch - a model defined in OpenAPI

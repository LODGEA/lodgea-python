...
class LocationSearchPost400ResponseValidationErrorsInner(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, message, path, *args, **kwargs):  # noqa: E501
        """LocationSearchPost400ResponseValidationErrorsInner - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, message, path, *args, **kwargs):  # noqa: E501
        """LocationSearchPost400ResponseValidationErrorsInner - a model defined in OpenAPI

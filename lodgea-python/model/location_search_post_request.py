...
class LocationSearchPostRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, search_text, currency_code, language_code, *args, **kwargs):  # noqa: E501
        """LocationSearchPostRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, search_text, currency_code, language_code, *args, **kwargs):  # noqa: E501
        """LocationSearchPostRequest - a model defined in OpenAPI
